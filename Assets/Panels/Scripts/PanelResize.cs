...
namespace Panels
{
    public class PanelResize : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        {
            panel.draggedZones.Clear();
            panel.draggedZones.AddRange(panel.ClickedResizeZones(eventData.position));
            //Debug.Log(panel.draggedZones.Count);
